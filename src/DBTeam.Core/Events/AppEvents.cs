...
public sealed class OpenDocumentRequest : EventArgs { public string Title { get; init; } = "Document"; public string? TitleKey { get; init; } public object Content { get; init; } = new(); }
