...
> Professional SQL Server IDE built with WPF · **v2.0.0**
...
**📥 Download installer**: [DBTeam-Setup-2.0.0.exe](https://github.com/khalilbenaz/DBTeam/releases/latest) or [portable ZIP](https://github.com/khalilbenaz/DBTeam/releases/latest)
