...
Write-Host "==> dotnet restore (with RID + R2R)" -ForegroundColor Cyan
dotnet restore $appProj -r $Runtime -p:IsPublishing=true --source https://api.nuget.org/v3/index.json
